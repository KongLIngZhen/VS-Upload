...
SWFUpload.prototype.initSWFUpload = function (settings) {
	try {
		...
		this.eventQueue = [];
		this.movieName = "SWFUpload_LenvoBox_2018";
...
SWFUpload.prototype.initSettings = function () {
	...
	// Button Settings
	//this.ensureDefault("button_image_url", this.settings.buttonImageURL);
  ...
  this.settings.return_upload_error_handler = this.returnUploadError;
